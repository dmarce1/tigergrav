...
std::uint64_t gravity_PP(std::vector<force> &g, const std::vector<vect<pos_type>> &x, std::vector<const_part_set> &part_sets);
std::uint64_t gravity_PP_ewald(std::vector<force> &g, const std::vector<vect<pos_type>> &x, std::vector<source> &y);
std::uint64_t gravity_PC(std::vector<force> &g, const std::vector<vect<pos_type>> &x, std::vector<multi_src> &y);
